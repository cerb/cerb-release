...
if(!defined('APP_DB_OPT_MASTER_READ_TIMEOUT_SECS'))
...
if(!defined('APP_DB_OPT_READER_READ_TIMEOUT_SECS'))
...
if(!defined('APP_SECURITY_CSP_FRAME_SRC'))
	define('APP_SECURITY_CSP_FRAME_SRC', defined('APP_SECURITY_CSP_FRAME_SRC') ? APP_SECURITY_CSP_FRAME_SRC : '');

if(!defined('APP_SECURITY_CSP_IMG_SRC'))
	define('APP_SECURITY_CSP_IMG_SRC', defined('APP_SECURITY_CSP_IMG_SRC') ? APP_SECURITY_CSP_IMG_SRC : '');

if(!defined('APP_SECURITY_CSP_MEDIA_SRC'))
	define('APP_SECURITY_CSP_MEDIA_SRC', defined('APP_SECURITY_CSP_MEDIA_SRC') ? APP_SECURITY_CSP_MEDIA_SRC : '');

if(!defined('APP_SECURITY_CSP_OBJECT_SRC'))
	define('APP_SECURITY_CSP_OBJECT_SRC', defined('APP_SECURITY_CSP_OBJECT_SRC') ? APP_SECURITY_CSP_IMG_SRC : '');

if(!defined('APP_SECURITY_CSP_SCRIPT_SRC'))
	define('APP_SECURITY_CSP_SCRIPT_SRC', defined('APP_SECURITY_CSP_SCRIPT_SRC') ? APP_SECURITY_CSP_SCRIPT_SRC : '');

if(!defined('APP_SECURITY_CSP_STYLE_SRC'))
	define('APP_SECURITY_CSP_STYLE_SRC', defined('APP_SECURITY_CSP_STYLE_SRC') ? APP_SECURITY_CSP_STYLE_SRC : '');
...
if(!defined('DEVELOPMENT_MODE_ALLOW_DEBUG'))
	define('DEVELOPMENT_MODE_ALLOW_DEBUG', false);

if(!defined('DEVELOPMENT_MODE_SECURITY_SCAN'))
	define('DEVELOPMENT_MODE_SECURITY_SCAN', false);

if(!defined('APP_OPT_DEPRECATED_PORTAL_CUSTOM_TEMPLATES'))
	define('APP_OPT_DEPRECATED_PORTAL_CUSTOM_TEMPLATES', true);
...
if(!defined('APP_OPT_GROUP_BEHAVIOR_TRIGGERS'))
	define('APP_OPT_GROUP_BEHAVIOR_TRIGGERS', false);
