<div id="widget{$widget->id}Config" style="margin-top:10px;">
	<fieldset id="widget{$widget->id}QueryEditor" class="peek">
		...
		<div style="margin:5px 0 0 20px;">
			<div>
				...
				<textarea name="params[placeholder_simulator_kata]" class="cerb-data-query-editor-placeholders" data-editor-mode="ace/mode/cerb_kata">{$widget->params.placeholder_simulator_kata}</textarea>
			</div>
	...
	<fieldset id="widget{$widget->id}Columns" class="peek">
		...
		<textarea name="params[sheet_kata]" class="cerb-sheet-yaml-editor placeholders" data-editor-mode="ace/mode/cerb_kata" style="width:95%;height:50px;">{$widget->params.sheet_kata}</textarea>
...
"
				...
				<textarea name="params[toolbar_kata]" class="cerb-toolbar-yaml-editor placeholders" data-editor-mode="ace/mode/cerb_kata" style="width:95%;height:50px;">{$widget->params.toolbar_kata}</textarea>
...
$(function() {
	...
	var $toolbar = $('#widget{$widget->id}Toolbar');
